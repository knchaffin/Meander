...
Just as the circle of 5ths Harmonic Degree can be controlled via CV input in V/Deg form, the same informtion can be sent out from the Meander circle of 5ths in V/Deg forn, either in the range of "1.0v = I, 2.0v = II, ... , 7.0v=VII" or  "0.0v = I, 1.0v = II, ... , 6.0v=VII" with the two ranges selectable in the Meander right click options menu.  
  
The 1.0v-7.0v option is the default and this can be sent to the circle V/Deg input on a 2nd Meander instance so that the first Meander instance can sequence the harmonic progression on the 2nd Meander instance.  Ideally, the two Meander instances would be set to the same mode and root scales, but this is not required, but advised to avoid horrible dissonances. 
